...
\newcommand{\titulotrabajo}{CoWordle, un juego para todos}
...
También se describen los objetivos de la práctica y el avance de la aplicación a lo largo del tiempo; la arquitectura escogida, que cuenta con dos proyectos distintos, una webapp y un servidor de WebSockets; Se explicaran el diseño visual creado inspirado por el Wordle original; Y se describirán cuales son las posibilidades para desplegar la aplicación utilizando GitHub y utilizando Docker.
