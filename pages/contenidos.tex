...
Una de las principales diferencias entre Node.js y otros sistemas como el motor de PHP, es que no es necesario levantar un proceso para cada llamada, en su lugar, Node.js es capaz de ir recibiendo llamadas e irlas respondiendo en un único hilo de ejecución pero con un sistema de eventos que permite responder varias peticiones simultáneamente \alumno{¿Es simultaneamene más preciso? Según he estado mirando en los links que me pasaste el procesamiento usa una cola de eventos}\tutor{Quita simultaneamente, Node.js responde de manera asíncrona, no simultanea (efectivamente, va encolando eventos)}, esto le permite responder mucho más rápido y eficientemente que otros sistemas.
