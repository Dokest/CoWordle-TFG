\tutor{Sugerencia: Tal y cómo se planteó ....} Según lo que se planteó para el desarrollo de la aplicación, se han llegado a alcanzar la mayoría de los objetivos, incluso aquellos que parecían más complejos.

\section{Resolución de objetivos}

\subsection{Aprendizaje websocket}
Este objetivo ha sido cumplido, \tutor{Parte la frase aquí con un punto, al leerla queda muy rara} no solo se han llegado a entender las diferencias entre la comunicación HTTP y websockets, si no que se han construido herramientas y sistemas sobre la comunicación websocket que han permitido realizar el trabajo de manera más sencilla y mantenible.
...
Aunque hubiera sido posible añadir más opciones de juego, y más mejoras.\tutor{Quita esta frase, le resta valor a tu trabajo, más adelante ya hablas de futuras ampliaciones}
...
\begin{itemize}
	\item La creación de un sistema de leaderboard global, para poder comparar tus resultados con los de jugadores de todo el mundo. Este desarrollo se llegó a plantear en una de las revisiones con el tutor, pero por falta de tiempo no pudo llegar a desarrollarse. \tutor{No hace falta excusarlo, se asume que no da tiempo a todo}
	\item Añadir más listas de palabras para jugar, \tutor{de esta forma ...} podría haber partidas en más lenguajes, o incluso partidas temáticas. El sistema de creación de listas es adaptable, y está preparado para introducir más listas en el futuro sin mucho trabajo.
	\item Incluir CI/CD, que por falta de tiempo no se ha llegado a terminar.\tutor{Eliminaria esto}
...
Estoy muy contento con el resultado, aunque una vez terminado y analizado, existen muchos sitios donde es mejorable tanto el código, como la arquitectura. Dicho esto, estoy satisfecho con lo bien que han salido para ser la primera vez que intento hacer un juego en el navegador. También estoy muy contento con el aspecto visual, creo que ha quedado resultón\tutor{poco formal, 'vistoso'? 'llamativo'?}, y sorprendentemente mejor de lo que me esperaba.
